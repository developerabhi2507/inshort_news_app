...
class AppColor {
  ...
  static const Color bg1Light = Color(0xFFFF9212);
  ...
  static const Color buttonBg1Light = Color(0xFFFF9212);
  ...
  // elevated button color for elevated style2
  static const Color buttonBg3Light = Color(0xFF1246FF);
  static const Color buttonFg3Light = Color(0xFFFFFFFF);
  // textButtonColor for textStyle1
  static const Color buttonFg4Light = Color(0xFF000000);
  // textButtonColor for textStyle2
  static const Color buttonFg5Light = Color(0xFFC26C06);
  // all buttons overlay colors
  static const Color buttonOverLayLight = Colors.grey;

  // Icon Colors
  static const Color iconLight = Color(0xFFFF9212);
  ...
  // textButtonColor for textStyle2
  static const Color buttonFg4Dark = Color(0xFF000000);
  // all buttons overlay colors
  ...
  // Border Colors
  // all border colors
  static const Color border1 = Color(0xFFFF9212);
  // all border colors
  ...
  static const Color fillColor = Color(0xFFFF9212);
